...
#     @staticmethod
#     def m2(self, num):
#         print(self, num)  # when we declare and call the static method inside the class ,# we have to give value for self parameter
#
#
# #
# mc = MyClass()
...
#     def add(self,d):
#         print(self.a+self.b +d)  # a, b are class variable.
#         when we use class variable inside the method , should use --self.variable
#     def mul(self,c):
